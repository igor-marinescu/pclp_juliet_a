...
#-------------------------------------------------------------------------------
def generate_infograph(pclp_m, proc, infograph_filename):
    """ Generate infograph
    ...
    # Generate dictionaries for category results
    res_cat_dict = {}
    ...
    # Generate dictionaries with values and unique colors for false-positive and true-positive issues
    issues_dict_fp = {}
    issues_dict_tp = {}
    issues_dict_all = {}
    issues_dict_all_raw = {}
    ...
    issues_col_fp["others"] = "sandybrown"
    issues_col_tp = generate_issues_colors(issues_dict_tp, [ctp_list_g, ctp_list_t, ctp_list_b])
    issues_col_tp["others"] = "sandybrown"

    # Generate pies
    generate_pie.gen_pie(axs[0][0], "false-positive\nvs\ntrue-positive", res_cat_dict, res_cat_colors)
    generate_pie.gen_pie(axs[0][1], "all issues", issues_dict_all, issues_col_fp, issues_col_tp)
    generate_pie.gen_pie(axs[1][0], "false-positive\nissues", issues_dict_fp, issues_col_fp)
    generate_pie.gen_pie(axs[1][1], "true-positive\nissues", issues_dict_tp, issues_col_tp)
